...
# Write the function
save_scatter_bill_len_bill_depth <- function(data, species){
  ggplot(data = data, aes(bill_length_mm, bill_depth_mm)) + 
  geom_point() + # Scatter plot
  ggtitle(paste0("Species: ", species)) # Add a title
  
  ggsave(filename = paste0("output/", species,"_scatterplot.png"))
}

# Try it out first across whole dataset
save_scatter_bill_len_bill_depth(penguins, "all_penguins_")

# Walk it
penguins |> 
  split(~species) |> 
  iwalk(~save_scatter_bill_len_bill_depth(.x, .y))
